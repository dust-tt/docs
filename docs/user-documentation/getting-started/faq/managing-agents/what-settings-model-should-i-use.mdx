...
Start with an auto model, and use **Standard** unless you have a reason not to. [Auto models](/docs/user-documentation/agents/model-selection#auto-models) has the table of which one to use for what.

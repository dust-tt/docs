...
3. Ask it to import your open items: _"Read all open Jira tickets assigned to this team and create a matching task in this Pod for each one"_
...
Example prompt: _"Every weekday morning, check for new open Jira tickets in project XYZ and create a task in this Pod for any that don't already exist. Also check for tasks in this Pod that are marked done and close the corresponding Jira ticket. Use the wake-up tool to schedule this automatically."_

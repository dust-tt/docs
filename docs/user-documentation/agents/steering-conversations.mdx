---
title: "Steering: Conversations that keep up with you"
---
...
<Info>
_**Why does it finish its current step first?** Cutting the agent off mid-action would leave its reasoning in an inconsistent state. Completing the current round first means your correction actually lands cleanly._
</Info>

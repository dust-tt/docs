...
This skill gives access to your agent to the same capabilities as the [`@deep-dive`](/docs/user-documentation/agents/default-agents/deep-dive-agent) global agent.

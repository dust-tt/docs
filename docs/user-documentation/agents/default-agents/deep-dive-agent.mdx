...
<Info>
Default agents like `@deep-dive` are provided by Dust and can't be edited through the Agent Builder. Workspace admins can only enable or disable them; their instructions and tools aren't customizable.
</Info>

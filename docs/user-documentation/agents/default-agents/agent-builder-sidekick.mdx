...
<Info>
Sidekick works inside the Agent Builder only. It's not a mentionable agent: you can't call it with `@sidekick` from a conversation, and it doesn't have an API.
</Info>

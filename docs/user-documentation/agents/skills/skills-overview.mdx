---
title: Overview
description: Reusable packages of instructions, knowledge, and tools you can share across multiple agents.
---
...
<Note>
  To share a direct link to a skill, open **Manage Skills**, select the skill, and click **Copy link**. The link opens the recipient's **Manage Skills** view on that skill, subject to normal workspace permissions.
</Note>

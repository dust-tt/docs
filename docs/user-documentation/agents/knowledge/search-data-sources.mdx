...
This used to be a manual toggle under Search > Advanced settings, but that toggle is gone now. For **SharePoint through Content search, folder and path navigation is turned on by default for new knowledge configurations.**

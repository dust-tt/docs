...
Databricks documents OAuth app connections under **Settings > App Connections**. OAuth applications with a client secret are confidential clients, which is the configuration required by the Dust presets. Read the [official documentation](https://docs.databricks.com/aws/en/agents/mcp-tools/connect-clients)

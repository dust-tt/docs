...
If you need actions to appear as coming from a bot rather than your personal account, see the Slack Bot MCP tool (available on request by contacting support@dust.tt).

...
## :ok_person: Adding Tools to Agents
...
If you need actions to appear as coming from a bot rather than your personal account, see the Slack Bot MCP tool. A workspace admin can enable it under **Administration** > **Tools**, then attach it to the relevant Space under **Spaces** > **Tools**, and add it to agents in the Agent Builder.

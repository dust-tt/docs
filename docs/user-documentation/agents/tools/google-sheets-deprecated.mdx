---
title: "[Deprecated] Google Sheets"
---
...
Go to [Google Cloud](https://console.cloud.google.com). Pick one of your project or create a new one. Then in the search bar, type "_Google Auth platform_" and pick "Clients".

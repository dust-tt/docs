...
* **Power Platform Access**: get the _Power Automate Premium_ [license](https://www.microsoft.com/power-platform/products/power-automate/pricing)
...
* **Power Platform Access**: get the _Power Automate Premium_ [license](https://www.microsoft.com/power-platform/products/power-automate/pricing). Ask your admin to grant you a licence.
* **Dust Account**: Active Dust workspace with API access
* **API Credentials**: Create a Dust API key from your workspace settings
  1. _Log into Dust_*
     * Go to [dust.tt](https://dust.tt)
...
4. Select the Dust connector you want to use (either _Talk to an Agent_ or _Upload document_)

...
If you want to add a tool as a Connection, ask your Super Admin, or a group granted the connector management capability under Workspace & Governance, to look for [Connections Management](/docs/user-documentation/data-sources/overview)

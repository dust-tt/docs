...
<HTMLBlock>{`
<div class="wistia_responsive_padding" style="padding:62.5% 0 0 0;position:relative;"><div class="wistia_responsive_wrapper" style="height:100%;left:0;position:absolute;top:0;width:100%;"></div></div>
<script src="https://fast.wistia.net/assets/external/E-v1.js" async></script>
`}</HTMLBlock>

With the **connector management** capability (held by Super Admins by default, or delegated to a group under Workspace & Governance), you can set up new website connections on **Spaces** > **Connections**.

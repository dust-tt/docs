...
With the **connector management** capability (held by Admins by default, or delegated to a group under Workspace & Governance), you can set up new website connections on **Spaces** > **Connections**.

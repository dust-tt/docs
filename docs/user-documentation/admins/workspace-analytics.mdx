...
Track adoption, credit consumption, and usage patterns across your workspace from **Admin > Analytics**. **Super Admins** and **Managers** can access this page.

<HTMLBlock>{`
<div class="wistia_responsive_padding" style="padding:62.08% 0 0 0;position:relative;"><div class="wistia_responsive_wrapper" style="height:100%;left:0;position:absolute;top:0;width:100%;"></div></div>
...
You can pull usage data programmatically through the [Export workspace analytics](/docs/developer-platform/dust-api-documentation/export-workspace-analytics) endpoint. A Dust API key with **workspace administration** scope is required to call this endpoint.

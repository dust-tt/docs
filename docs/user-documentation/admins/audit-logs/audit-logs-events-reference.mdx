...
| `group.member_added` | A user was added to a manually managed group; targets: `workspace`, `group`, `user`; metadata: `group_name`, `user_email`, `actor_type` |
| `group.member_removed` | A user was removed from a manually managed group; targets: `workspace`, `group`, `user`; metadata: `group_name`, `user_email`, `actor_type` |
...
| Event | Description |
|---|---|
| `frame.email_grant_added` | Email sharing grants were added to a Frame; targets: `workspace`, `frame`; metadata: `frame_name`, `emails`, `actor_type` |
| `frame.email_grant_revoked` | An email sharing grant was revoked from a Frame; targets: `workspace`, `frame`; metadata: `frame_name`, `grant_id`, `actor_type` |
| `frame.share_scope_updated` | A Frame's sharing scope was updated; targets: `workspace`, `frame`; metadata: `frame_name`, `share_scope`, `actor_type` |

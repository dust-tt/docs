---
title: "Audit Logs: Events Reference"
---
...
| `agent.publication_state_changed` | An agent's publication state was changed (e.g. Unpublished → Published → Discoverable) |
...
| Event | Description |
|---|---|
| `skill.publication_state_changed` | A skill's publication state was changed (e.g. Unpublished → Published) |
...
| `membership.role_updated` | A member's role was changed (e.g. Member → Manager, Manager → Super Admin) |
...
| Event | Description |
|---|---|
| `group.created` | A manual group was created |
| `group.deleted` | A manual group was deleted |
| `group.updated` | A manual group's name or description was updated |
| `group.member_added` | A user was added to a group |
| `group.member_removed` | A user was removed from a group |
| `group.exception_granted` | A group exception was granted, giving a user additional access beyond their role |

## Governance

| Event | Description |
|---|---|
| `governance.capability_updated` | A governance capability's configuration was changed (e.g. `Publish agents` reassigned to a different group) |
| `governance.capability_mode_changed` | A governance capability's mode was changed (Everyone / Groups / Admin only) |
| `governance.delegated_action` | A Manager performed a delegated administrative action (e.g. inviting a member, changing a role) |

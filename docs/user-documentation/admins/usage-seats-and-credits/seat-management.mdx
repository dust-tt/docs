...
Roles and seat types are independent: a Super Admin can hold a Free seat, and a Member can hold a Pro seat.
...
**Super Admins** and **Managers** can assign and change seats from **Admin > Members**.
...
**Super Admins** and **Managers** can change a member's seat type at any time from **Admin > Usage**, in the Members list, using the **Change seat type** action. Timing depends on the direction of the change:
...
When members reach their credit limit, they are blocked from sending messages. **Super Admins** and **Managers** can allow members to request a seat upgrade instead of being silently blocked.

To enable this, go to **Admin > Usage > Settings** and turn on the **Upgrade request** toggle. Once enabled, blocked members see a prompt to request an upgrade. **Super Admins** and **Managers** can then review and act on pending requests from the **Requests** tab in the Members section.

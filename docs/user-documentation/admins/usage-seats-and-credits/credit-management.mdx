...
* **Business plan**: admins can purchase top-up credit packages as needed.
...
* **Upgrade request**: when enabled, members who reach their credit limit can request an upgrade instead of being immediately blocked. Workspace admins can review and act on those requests from the Requests tab in the Members section.

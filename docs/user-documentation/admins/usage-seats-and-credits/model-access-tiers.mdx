...
The lists below match the model options shown by the model-tier information panel as of August 14, 2026. They include the model and reasoning-effort combinations currently assigned to each tier. Dust can change these assignments as providers release models, update pricing, or change availability.

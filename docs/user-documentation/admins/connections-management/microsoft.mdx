...
| Microsoft Graph | SensitivityLabels.Read.All | Get labels app scope. | **Delegated** | Admin consent | An administrator |
| Microsoft Graph | offline\_access | Maintain access to data you... | **Delegated** | Admin consent | An administrator |
...
| --- | --- | --- | --- | --- | --- |
| Microsoft Graph | Files.Read.All | Read all files that user can a... | **Delegated** | Admin consent | An administrator |
| Microsoft Graph | Sites.Read.All <br />or<br />Sites.Selected | Read items in all site collecti... | **Delegated** | Admin consent | An administrator |
| Microsoft Graph | User.Read | Sign in and read user profile | **Delegated** | Admin consent | An administrator |
| Microsoft Graph | SensitivityLabels.Read.All | Get labels app scope. | **Delegated** | Admin consent | An administrator |
| Microsoft Graph | offline\_access | Maintain access to data you... | **Delegated** | Admin consent | An administrator |

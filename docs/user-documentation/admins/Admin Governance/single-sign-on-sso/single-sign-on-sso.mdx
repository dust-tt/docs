...
SSO configuration is an IT & Security setting and requires the **Super Admin** role.
...
1. In Dust, navigate to **Admin > Workspace & Governance > IT & Security > Single Sign-On > Activate SSO**

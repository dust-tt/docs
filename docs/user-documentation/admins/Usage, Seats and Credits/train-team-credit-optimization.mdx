...
| Cadence       | What to do                                                                                                                                                                                                                                         |
| ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Weekly**    | Admins review the shape of usage: top agents, top sources, programmatic growth, expensive model usage, deep research usage, and sudden changes. See [Workspace analytics](/docs/user-documentation/admins/workspace-analytics) and [Credit management](/docs/user-documentation/admins/usage-seats-and-credits/credit-management). |

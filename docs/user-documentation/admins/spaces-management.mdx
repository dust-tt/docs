...
<Info>
Space-scoped delegated administration is not available in this release. Only Super Admins, or a group granted the space administration capability under Workspace & Governance, can create spaces and manage space membership.
</Info>
...
* Managed by: Super Admins, or a group granted the space administration capability under Workspace & Governance
...
Only Super Admins, or a group granted the space administration capability under Workspace & Governance, can create and manage spaces:
...
_Note:_ Only Super Admins, or a group granted the connector management capability under Workspace & Governance, can add data from **Connections** to a space.
...
* in Open spaces: only Super Admins, or a group granted the corresponding administration capability under Workspace & Governance, can add data

...
1. In Github : create an OAuth app from the [developer settings](https://github.com/settings/developers) page
   ...
   2. Use the callback URL for your Dust deployment as the redirect URI:
      * Global: `https://dust.tt/oauth/mcp_static/finalize`
      * EU: `https://eu.dust.tt/oauth/mcp_static/finalize`

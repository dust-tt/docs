...
**Setup**: A Admin, or a group member granted the corresponding administration capability under Workspace & Governance, provides credentials during tool setup
...
**Setup**: A Admin (or group member with the administration capability under Workspace & Governance) completes the initial OAuth flow, then each user authenticates individually

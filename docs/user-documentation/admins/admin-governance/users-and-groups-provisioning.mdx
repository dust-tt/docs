...
You can automatically assign admin and builder roles to your users by adding them into special groups (exactly) named "**dust-admins**" and "**dust-builders**". You will have to create these groups in your IdP, assign appropriate members to them and synchronize them.
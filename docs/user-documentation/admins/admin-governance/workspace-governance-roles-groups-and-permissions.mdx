...
- Enable or disable Frame sharing for the workspace
...
Managers cannot enable or disable Frame sharing or audit logs. When Frame sharing is enabled, Managers can configure which groups may invite users to Frames and publish Frames.
...
| Invite users to Frames | Yes when Frame sharing is enabled | When granted | When granted, if Frame sharing is enabled |
| Publish Frames | Yes when Frame sharing is enabled | When granted | When granted, if Frame sharing is enabled |

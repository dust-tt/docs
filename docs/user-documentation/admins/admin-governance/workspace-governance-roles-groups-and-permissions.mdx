...
| Invite users to Frames | Yes when the feature is enabled | When granted | When granted, if Frames is enabled |
| Publish Frames | Yes when the feature is enabled | When granted | When granted, if Frames is enabled |

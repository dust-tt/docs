...
Choose a Admin with full access to both your IdP admin dashboard and the Dust Admin panel. This is necessary as enabling SAML SSO requires creating a custom integration in your IdP.

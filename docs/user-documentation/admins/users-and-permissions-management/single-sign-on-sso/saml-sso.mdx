...
SAML SSO configuration is an IT & Security setting and requires the **Super Admin** role.
...
Choose a Super Admin with full access to both your IdP admin dashboard and the Dust Admin panel. This is necessary as enabling SAML SSO requires creating a custom integration in your IdP.

## 2. Get Your Dust SAML Configuration Values

1. In Dust, navigate to **Admin > Workspace & Governance > IT & Security > Single Sign-On > Activate Single Sign-On**
...
1. Return to the Dust SSO configuration page (**Admin > Workspace & Governance > IT & Security > Single Sign-On > Activate Single Sign-On**)

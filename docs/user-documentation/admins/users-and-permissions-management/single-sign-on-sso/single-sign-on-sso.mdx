...
SSO configuration is an IT & Security setting and requires the **Admin** role (or a group granted **Security access**).
...
1. In Dust, navigate to **Admin > IT & Security > Single Sign-On > Activate SSO**
2. Select your IdP from the list
3. Follow the steps to create the app in your IdP and configure it with Dust.

For a detailed walkthrough of the SAML setup, see [SAML SSO](/docs/user-documentation/admins/users-and-permissions-management/single-sign-on-sso/saml-sso).

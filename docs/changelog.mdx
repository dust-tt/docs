...
• Users can now add schedules to their agents in the Agent Builder. More info here [/docs/user-documentation/agents/triggers/schedules#/](https://docs.dust.tt/docs/scheduling-your-agent-beta#/)

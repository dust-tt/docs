...
Grok 4.6 is now available in Dust with zero data retention. You can select it directly from the input bar or agent builder, with no feature flag required. It is available to all users except workspaces with EU data residency only enabled, because Grok 4.6 processes data in the US.

...
<Update label="September 23rd, 2026" tags={["Added"]}>
## Automatic fallback during model provider outages

Auto models now skip models affected by a detected provider outage and use the next available candidate. The model picker shows the temporary replacement, and Dust warns you when fallback occurs. If a provider error prevents a message from running on a specifically selected model, you can retry with the corresponding auto-model level.
...
<Update label="September 23rd, 2026" tags={["Added"]} rss={{ title: "GPT-6 Luna, GPT-6 Sol, and Claude Opus 5.5 support" }}>
## GPT-6 Luna support
...
<Update label="September 22nd, 2026" tags={["Added"]} rss={{ title: "Choose Grok 4.7 for your agents" }}>
...
<Update label="September 21st, 2026" tags={["Added"]} rss={{ title: "Replace selected text with any Dust agent from Raycast" }}>
...
<Update label="September 21st, 2026" tags={["Added"]} rss={{ title: "Circuit breaker for high-credit agent messages" }}>
...
<Update label="September 17th, 2026" tags={["Added"]} rss={{ title: "Grok 4.6 is now available in Dust" }}>
...
<Update label="September 17th, 2026" tags={["Added"]} rss={{ title: "Share frames with company domains" }}>
...
<Update label="September 16th, 2026" tags={["Added"]} rss={{ title: "Skill favorites" }}>
## Skill favorites
...
<Update label="September 15th, 2026" tags={["Improved"]} rss={{ title: "Choose a model from the keyboard" }}>
...
<Update label="September 15th, 2026" tags={["Improved"]} rss={{ title: "Scheduled runs on OpenAI models now use about half the credits" }}>
...
<Update label="September 14th, 2026" tags={["Added"]} rss={{ title: "Databricks official MCPs: SQL and Genie" }}>
...
<Update label="September 11th, 2026" tags={["Improved"]} rss={{ title: "Redesigned Usage page: understand and manage credits" }}>
...
<Update label="September 11th, 2026" tags={["Added"]} rss={{ title: "DeepSeek V4.1 Flash is now available" }}>
...
<Update label="September 11th, 2026" tags={["Added"]} rss={{ title: "Files as Pod tabs" }}>
## Files as Pod tabs
...
<Update label="September 10th, 2026" tags={["Added"]} rss={{ title: "Assign Admin and Manager roles from any workspace group" }}>
...
<Update label="September 8th, 2026" tags={["Added"]} rss={{ title: "Flexible space and pod permissions" }}>

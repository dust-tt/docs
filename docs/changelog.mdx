...
<Update label="September 25th, 2026" tags={["Added"]} rss={{ title: "New Ultra model tier for the most expensive models", description: "Admins can now cap access at Premium while keeping the most expensive models in a separate Ultra tier." }}>
## New Ultra model tier for the most expensive models

A new Ultra model tier separates the most expensive models, starting with GPT 6 Astra, from Premium. Workspaces with no model tier restriction keep access to every model, while admins can set a workspace, group, or member to Up to Premium to exclude Ultra models. Future models in the highest cost-per-task tier will also land in Ultra. Configure tier restrictions in Admin > Usage > Settings > Models tier. Available to all workspaces.

</Update>



<Update label="September 24th, 2026" tags={["Improved"]} rss={{ title: "More Control Over Credit Spend Checkpoints", description: "Admins and managers can now configure credit spend checkpoints for individual agents or their entire workspace." }}>
## More Control Over Credit Spend Checkpoints

Admins and managers can now configure credit spend checkpoints for individual agents in the Agent Builder, or turn the gate on or off for the entire workspace in Usage → Settings. When enabled, Dust pauses an agent after a message uses at least 600 LLM token credits and asks whether to continue.

Use the agent-level setting to let trusted agents run without interruption while keeping workspace-wide protection for other agents. Available to admins and managers.

</Update>
<Update label="September 24th, 2026" tags={["Improved"]} rss={{ title: "MCP tool settings are now easier to manage", description: "Organize MCP server tools, stakes, availability, and workspace access from clearer settings tabs." }}>
## MCP tool settings are now easier to manage

MCP tool settings now use separate General, Tools & Stakes, and Availability tabs. Search and select individual tools, use Select all, and apply bulk changes only to the tools you choose. You can also control skill restrictions and whether a tool is available workspace-wide or only in selected Spaces.

Available to everyone.

</Update>

<Update label="September 24th, 2026" tags={["Added"]} rss={{ title: "Qobra remote MCP", description: "Connect Qobra to Dust and let agents retrieve commissions, statements, and quotas within each user's existing permissions." }}>
## Qobra remote MCP

Qobra is now available in Dust's MCP catalog as two regional entries, Qobra (EU) and Qobra US. Connect through OAuth to let agents retrieve commissions, statements, and quotas using read-only tools scoped to each user's Qobra permissions. Admins can add it from Spaces > Tools; the customer's Qobra admin must first enable MCP in Your account > Settings > AI > MCP. Available in all workspaces.

</Update>

<Update label="September 23rd, 2026" tags={["Added"]} rss={{ title: "Automatic fallback during model provider outages", description: "Auto models now skip models affected by detected provider outages and use the next available candidate." }}>
## Automatic fallback during model provider outages

Auto models (**Basic**, **Standard**, and **Premium**) now skip models affected by detected provider outages and use the next available candidate. The model picker displays the temporary replacement. No additional setup is required.

Dust warns you but do not act on an outage for a model that you specifically selected. If a provider error causes a message to fail on a specific model, you can retry with the corresponding auto-model level. Please review completed actions before retrying to avoid duplicates. Read about [provider outage handling](/docs/user-documentation/agents/model-selection#provider-outages-and-automatic-fallback).

</Update>


<Update label="September 23rd, 2026" tags={["Added"]} rss={{ title: "GPT-6 Luna, GPT-6 Sol, and Claude Opus 5.5 support", description: "GPT-6 Luna, GPT-6 Sol, and Claude Opus 5.5 are now available for your Dust agents." }}>
## GPT-6 Luna support

GPT-6 Luna is now available as a model for new and existing agents in all workspaces, including the EU. It uses the same context window as GPT-5.6 Luna with lower token costs. Existing agents keep their current model, and no premium plan or model-specific feature flag is required.
  
## GPT-6 Sol support

You can now use GPT-6 Sol in your Dust agents, with availability in both the global and EU regions. Select GPT-6 Sol from the model picker when configuring an agent. It is available to workspaces on new credit pricing plans or with advanced-model access. No model-specific feature flag is required.

## Claude Opus 5.5 support

Claude Opus 5.5 is now available in Dust for coding and enterprise workflows. You can select it when building or configuring agents in workspaces on new credit pricing or with advanced-model access. The model is available globally and in the EU, with no model-specific feature flag required.

</Update>

<Update label="September 21st, 2026" tags={["Added"]} rss={{ title: "Siit remote MCP", description: "Siit is now available as a default remote MCP server in the Dust MCP catalog." }}>
## Siit remote MCP

Siit is now available as a default remote MCP server in Dust’s MCP catalog. Admins can add Siit from Spaces > Tools, connect it through OAuth, and let agents triage and act on internal IT and HR requests without leaving Dust.

Available in all workspaces. Once an admin adds Siit, anyone can use it in their agents.

</Update>



<Update label="September 22nd, 2026" tags={["Added"]} rss={{ title: "Choose Grok 4.7 for your agents", description: "Grok 4.7 is now available in the agent builder and input bar." }}>
...
<Update label="September 21st, 2026" tags={["Added"]} rss={{ title: "Replace selected text with any Dust agent from Raycast", description: "Bind any Dust agent to a Raycast Quicklink and replace selected text with the agent's response from any Mac app." }}>
...
<Update label="September 21st, 2026" tags={["Added"]} rss={{ title: "Circuit breaker for high-credit agent messages", description: "Dust now pauses an agent message after it consumes 600 LLM credits and asks whether you want to continue or stop." }}>
...
<Update label="September 17th, 2026" tags={["Added"]} rss={{ title: "Grok 4.6 is now available in Dust", description: "You can now select Grok 4.6, with zero data retention, from the input bar or agent builder." }}>
...
<Update label="September 17th, 2026" tags={["Added"]} rss={{ title: "Share frames with company domains", description: "You can now invite a company domain to a frame so anyone who verifies an email address on that domain can access it." }}>
...
<Update label="September 16th, 2026" tags={["Added"]} rss={{ title: "Skill favorites", description: "Star skills for quicker access, and let agents with Discover Skills use your favorite selection." }}>
## Skill favorites
...
<Update label="September 15th, 2026" tags={["Improved"]} rss={{ title: "Choose a model from the keyboard", description: "You can now pick a model in Composer without leaving the keyboard." }}>
## Choose a model from the keyboard

You can now pick a model in Composer without leaving the keyboard. Type `/model` or `/mo`, followed by part of a model name, then add `l`, `m`, or `h` to set low, medium, or high effort. Press Enter or Tab to select the result, or omit the effort suffix to use the model's default. Available to everyone.

</Update>

<Update label="September 15th, 2026" tags={["Improved"]} rss={{ title: "Scheduled runs on OpenAI models now use about half the credits", description: "Schedules, triggers, and wake-ups on OpenAI models now run on a lower-priority tier and consume about half the credits." }}>
...
<Update label="September 14th, 2026" tags={["Added"]} rss={{ title: "Databricks official MCPs: SQL and Genie", description: "Databricks official managed MCPs for SQL and Genie are now available in Dust as preset tools." }}>
...
<Update label="September 11th, 2026" tags={["Improved"]} rss={{ title: "Redesigned Usage page: understand and manage credits", description: "Admins and managers get a clearer view of workspace consumption, billing-cycle history, member usage, and spend limits." }}>
...
<Update label="September 11th, 2026" tags={["Added"]} rss={{ title: "DeepSeek V4.1 Flash is now available", description: "DeepSeek V4.1 Flash is now available in Dust through Fireworks." }}>
...
<Update label="September 11th, 2026" tags={["Added"]} rss={{ title: "Files as Pod tabs", description: "Pod editors can now add almost any file as a Pod tab." }}>
## Files as Pod tabs
...
<Update label="September 10th, 2026" tags={["Added"]} rss={{ title: "Assign Admin and Manager roles from any workspace group", description: "Admins can now assign the Admin or Manager role to any workspace group from Settings & Governance." }}>
...
<Update label="September 8th, 2026" tags={["Added"]} rss={{ title: "Flexible space and pod permissions", description: "Manage access to spaces and pods with individual members and groups at the same time." }}>
...
<Update label="September 5th, 2026" tags={["Added"]} rss={{ title: "GPT6 Astra" }}>
## GPT6 Astra
...
<Update label="August 26th, 2026" tags={["Added"]} rss={{ title: "Credit pool usage for triggers" }}>
...
<Update label="August 14th, 2026" tags={["Added"]} rss={{ title: "Slack auto-replies without an @mention" }}>
...
<Update label="August 10th, 2026" tags={["Added"]} rss={{ title: "Choose the model from the composer" }}>
...
<Update label="August 10th, 2026" tags={["Added"]} rss={{ title: "Restrict access to model tiers" }}>
...
<Update label="August 4th, 2026" tags={["Added"]} rss={{ title: "Modjo MCP is now available" }}>
...
<Update label="July 31st, 2026" tags={["Added"]} rss={{ title: "Workspaces can now choose a skill’s availability" }}>
...
<Update label="July 30th, 2026" tags={["Added"]} rss={{ title: "Restrict a tool to skills" }}>
...
<Update label="July 29th, 2026" tags={["Added"]} rss={{ title: "Admin governance controls" }}>
...
<Update label="July 27th, 2026" tags={["Added"]} rss={{ title: "Kimi K3 via Fireworks AI" }}>
...
<Update label="July 22nd, 2026" tags={["Added"]} rss={{ title: "Connect your personal Zendesk account" }}>
...
<Update label="July 10th, 2026" tags={["Added"]} rss={{ title: "Slack MCP Improvements: Reactions, Status Updates, and Optional \"Sent by Agent\" Footer" }}>
...
<Update label="July 10th, 2026" tags={["Added"]} rss={{ title: "GPT-5.6 Sol, Terra & Luna Are Now Available on Dust" }}>
...
<Update label="July 8th, 2026" tags={["Added"]} rss={{ title: "🔔 Sound Notification When an Agent Needs Your Approval" }}>
...
<Update label="July 8th, 2026" tags={["Added"]} rss={{ title: "Set Default Skills in Pods" }}>
...
<Update label="July 6th, 2026" tags={["Added"]} rss={{ title: "Select a Custom Default Agent in Pods" }}>
...
<Update label="July 3rd, 2026" tags={["Added"]} rss={{ title: "Triggers Now Run Inside Pods" }}>
...
<Update label="June 30th, 2026" tags={["Added"]} rss={{ title: "Claude Sonnet 5 is Now Available on Dust" }}>
...
<Update label="June 30th, 2026" tags={["Added"]} rss={{ title: "Youtrust Remote MCP Server Now Available in Dust" }}>
  ...
  _Note: this integration is available to anyone using Youtrust. If you'd like help setting up a specific use case, your Customer Success contact is happy to assist._
</Update>

<Update label="June 30th, 2026" tags={["Added"]} rss={{ title: "Agents Can Now Ask You Clarifying Questions: Available Everywhere" }}>
...
<Update label="June 30th, 2026" tags={["Added"]} rss={{ title: "The Computer: Let Your Agents Work Safely with Files, Code, and More" }}>
...
<Update label="June 24th, 2026" tags={["Added"]} rss={{ title: "Pods Now Apply Your AGENTS.md to Every Conversation" }}>
...
<Update label="June 17th, 2026" tags={["Added"]} rss={{ title: "Adomik Integration: Ad Revenue Analytics & Knowledge, Directly in Dust" }}>
...
<Update label="June 17th, 2026" tags={["Added"]} rss={{ title: "Lemlist MCP Server Now Available" }}>
...
<Update label="June 17th, 2026" tags={["Added"]} rss={{ title: "GLM 5.2 Now Available in Dust" }}>
...
<Update label="June 16th, 2026" tags={["Added"]} rss={{ title: "Email Threads Now Stay in a Single Conversation" }}>
...
<Update label="June 16th, 2026" tags={["Added"]} rss={{ title: "Clari Copilot Integration Now Available for All Workspaces" }}>
...
<Update label="June 15th, 2026" tags={["Added"]} rss={{ title: "Dust is now a remote MCP server" }}>
...
<Update label="June 8th, 2026" tags={["Added"]} rss={{ title: "Gamma MCP now available in Dust" }}>
...
<Update label="June 8th, 2026" tags={["Added"]} rss={{ title: "Skills in Skills: Compose Skills and Tools Directly Within Your Instructions" }}>
  ...
  _No action is required on your part, your existing skills continue to work as before. This is simply a new way to compose and reuse them going forward._
</Update>

<Update label="June 8th, 2026" tags={["Added"]} rss={{ title: "@dust can now build skills" }}>
...
<Update label="June 5th, 2026" tags={["Added"]} rss={{ title: "Dust Support: Get Instant, Grounded Support Answers from @dust" }}>
...
<Update label="June 4th, 2026" tags={["Added"]} rss={{ title: "Speech-to-Text for Audio & Video Files" }}>
...
<Update label="May 29th, 2026" tags={["Added"]} rss={{ title: "Pods: A Shared Workspace for Your Team and Your Agents" }}>
...
<Update label="May 28th, 2026" tags={["Added"]} rss={{ title: "Claude Opus 4.8 Now Available in the Agent Builder" }}>
...
<Update label="May 28th, 2026" tags={["Added"]} rss={{ title: "Apify MCP Is Now Available in Dust" }}>
...
<Update label="May 28th, 2026" tags={["Added"]} rss={{ title: "Six New Integrations Now Available in Dust" }}>
...
<Update label="May 27th, 2026" tags={["Added"]} rss={{ title: "Costory MCP Now Available in Dust" }}>
...
<Update label="May 27th, 2026" tags={["Added"]} rss={{ title: "Praiz is Now Available as a Remote MCP Tool in Dust" }}>
...
<Update label="May 27th, 2026" tags={["Added"]} rss={{ title: "Monday.com MCP: Now Available for All Workspaces" }}>
...
<Update label="May 27th, 2026" tags={["Added"]} rss={{ title: "Confluence MCP is Now Generally Available" }}>
...
<Update label="May 27th, 2026" tags={["Added"]} rss={{ title: "Luma MCP Server: Now Generally Available" }}>
...
<Update label="May 27th, 2026" tags={["Added"]} rss={{ title: "Snowflake MCP Server: Now Generally Available" }}>
...
<Update label="May 26th, 2026" tags={["Added"]} rss={{ title: "Contentsquare Remote MCP Now Available in Dust" }}>
...
<Update label="May 23rd, 2026" tags={["Added"]} rss={{ title: "Collapsing Input Bar on Mobile for Better Reading" }}>
...
<Update label="May 22nd, 2026" tags={["Added"]} rss={{ title: "Agents Can Now Export Frames as PDF or PNG" }}>
...
<Update label="May 22nd, 2026" tags={["Added"]} rss={{ title: "Inline Text Editing in Frames: Tweak Your Content Without Reprompting" }}>
...
<Update label="May 20th, 2026" tags={["Added"]} rss={{ title: "Gemini 3.5 Flash Now Available on Dust" }}>
...
<Update label="May 19th, 2026" tags={["Added"]} rss={{ title: "LLM Model Refresh: Grok 4.3 Upgrade and Anthropic Model Migrations" }}>
...
<Update label="May 11th, 2026" tags={["Added"]} rss={{ title: "Branching Conversations" }}>
...
<Update label="May 11th, 2026" tags={["Added"]} rss={{ title: "Asana MCP update" }}>
  ## Asana MCP update
...
<Update label="May 7th, 2026" tags={["Added"]} rss={{ title: "🔒 Audit Logs for Enterprise Workspaces" }}>
...
<Update label="May 7th, 2026" tags={["Added"]} rss={{ title: "Agents can now see images returned by MCP tools" }}>
...
<Update label="May 6th, 2026" tags={["Added"]} rss={{ title: "Context Compaction: Keep Your Agents Sharp in Long Conversations" }}>
...
<Update label="May 4th, 2026" tags={["Added"]} rss={{ title: "GMail Labels Management and Email Archiving" }}>
...
<Update label="April 29th, 2026" tags={["Added"]} rss={{ title: "Wake-ups: Agents can now schedule themselves to continue work later" }}>
...
<Update label="April 28th, 2026" tags={["Added"]} rss={{ title: "Gong Tools Integration via MCP" }}>
...
<Update label="April 28th, 2026" tags={["Added"]} rss={{ title: "Slash Commands Now Available in the Input Bar" }}>
...
<Update label="April 24th, 2026" tags={["Added"]} rss={{ title: "GPT 5.5 now available on Dust" }}>
...
<Update label="April 22nd, 2026" tags={["Added"]} rss={{ title: "GPT Image 2: Enhanced Image Generation Now Default on Dust" }}>
...
<Update label="April 20th, 2026" tags={["Added"]} rss={{ title: "Agents can now ask you questions to clarify their next steps" }}>
...
<Update label="April 17th, 2026" tags={["Added"]} rss={{ title: "🔒 Private-by-default conversation URLs" }}>
...
<Update label="April 17th, 2026" tags={["Added"]} rss={{ title: "Import skills from GitHub or .zip file" }}>
...
<Update label="April 16th, 2026" tags={["Added"]} rss={{ title: "Steering: Conversations That Keep Up With You" }}>
  ## Steering: Conversations That Keep Up With You

  🎯 **What is it?**

  Steering lets you send messages to Dust agents _while the agent is working_. You can now see every step of the agent's work in real-time (thinking, tool calls, searches) and redirect it on the fly without canceling or losing progress. Additionally, messages are now scoped to one agent at a time, displayed in the input bar, so you no longer need to use @mentions.
...
<Update label="April 14th, 2026" tags={["Added"]} rss={{ title: "🦊 Dust Browser Extension Now Available on Firefox" }}>
...
<Update label="April 14th, 2026" tags={["Added"]} rss={{ title: "Microsoft Teams Meeting Transcripts Now Available in Dust" }}>
...
<Update label="April 13th, 2026" tags={["Added"]} rss={{ title: "📧 Share Frames with specific people via email invite" }}>
...
<Update label="April 9th, 2026" tags={["Added"]} rss={{ title: "Amplitude MCP Integration: Query Your Product Data with Natural Language" }}>
...
<Update label="April 9th, 2026" tags={["Added"]} rss={{ title: "Notion MCP Tools Now Use Official Notion Server" }}>
...
<Update label="April 8th, 2026" tags={["Added"]} rss={{ title: "Interactive Workspace Analytics Dashboard & Public API" }}>
...
<Update label="April 8th, 2026" tags={["Added"]} rss={{ title: "Workspace Analytics: Interactive Dashboard + Public API" }}>
...
<Update label="April 8th, 2026" tags={["Added"]} rss={{ title: "Slack responses: streaming, live actions & rich formatting" }}>
...
<Update label="April 8th, 2026" tags={["Added"]} rss={{ title: "GitOps sync for Skills & Agent configurations with GitHub Action" }}>
...
<Update label="April 6th, 2026" tags={["Added"]} rss={{ title: "Send Emails from Your Gmail Aliases" }}>
...
<Update label="April 1st, 2026" tags={["Added"]} rss={{ title: "Discover Skills - Find and leverage workspace capabilities directly in your agents" }}>
...
<Update label="April 1st, 2026" tags={["Added"]} rss={{ title: "Create Triggers on Any Agent You Can Talk To" }}>
...
<Update label="April 1st, 2026" tags={["Added"]} rss={{ title: "API Keys Can Now Be Scoped to Multiple Spaces" }}>
...
<Update label="March 31st, 2026" tags={["Added"]} rss={{ title: "Salesforce MCP Tool Can Now Create and Update Objects" }}>
...
<Update label="March 30th, 2026" tags={["Added"]} rss={{ title: "Email your agents directly at agent-name@dust.team" }}>
...
<Update label="March 30th, 2026" tags={["Added"]} rss={{ title: "Configurable OAuth Scopes for Microsoft MCP Tools" }}>
...
<Update label="March 20th, 2026" tags={["Added"]} rss={{ title: "Google Drive Tool: Create Files in a Folder and Share Them Directly from Dust" }}>
...
<Update label="March 20th, 2026" tags={["Added"]} rss={{ title: "Browser Extension Now Available on Arc & Edge" }}>
...
<Update label="March 20th, 2026" tags={["Added"]} rss={{ title: "Dust Extension: Agents Now Understand Your Browser" }}>
...
<Update label="March 20th, 2026" tags={["Added"]} rss={{ title: "Chrome Extension: Major Update" }}>
...
<Update label="March 19th, 2026" tags={["Added"]} rss={{ title: "Notion MCP now supports databases with multiple data sources" }}>
...
<Update label="March 18th, 2026" tags={["Added"]} rss={{ title: "Enhanced Speech Capabilities: Upgraded Audio Quality and 21 Languages Now Supported" }}>
...
<Update label="March 18th, 2026" tags={["Added"]} rss={{ title: "Miro Integration Now Available in Dust" }}>
...
<Update label="March 17th, 2026" tags={["Added"]} rss={{ title: "Fathom MCP Integration: Your Meeting Intelligence, Now in Dust" }}>
...
<Update label="March 17th, 2026" tags={["Added"]} rss={{ title: "One-Click Hex Integration via MCP Server" }}>
...
<Update label="March 17th, 2026" tags={["Added"]} rss={{ title: "Semrush MCP Integration: SEO Insights Directly in Your Agents" }}>
...
<Update label="March 16th, 2026" tags={["Added"]} rss={{ title: "Introducing Sidekick: Your AI Assistant for Building Better Agents" }}>
  ...
  **Converting conversations**: Had a productive back-and-forth with an agent? Use "Convert to agent" → Sidekick captures that conversation's tools, knowledge sources, and reasoning pattern into a reusable agent.
  ...
  📚 **Learn more**: [Agent Builder Sidekick documentation](/docs/user-documentation/agents/default-agents/agent-builder-sidekick)
...
<Update label="March 12th, 2026" tags={["Added"]} rss={{ title: "Enhanced Attachments Management in Conversations" }}>
...
<Update label="March 12th, 2026" tags={["Added"]} rss={{ title: "BigQuery connector: multi-project support" }}>
...
<Update label="March 11th, 2026" tags={["Improved"]} rss={{ title: "Slack Tool Now Uses Official Dust Marketplace App" }}>
...
<Update label="March 5th, 2026" tags={["Added"]} rss={{ title: "GPT 5.4 Now Available in Dust" }}>
...
<Update label="February 25th, 2026" tags={["Added"]} rss={{ title: "Statuspage MCP Server - Now Available" }}>
...
<Update label="February 25th, 2026" tags={["Added"]} rss={{ title: "Salesloft MCP Server Now Available" }}>
...
<Update label="February 25th, 2026" tags={["Added"]} rss={{ title: "Front MCP Server: Now Generally Available" }}>
...
<Update label="February 25th, 2026" tags={["Added"]} rss={{ title: "Ashby MCP Server Now Generally Available" }}>
...
<Update label="February 25th, 2026" tags={["Added"]} rss={{ title: "Slab MCP Server: Now Available" }}>
...
<Update label="February 23rd, 2026" tags={["Added"]} rss={{ title: "Better Support for Slideshow Frames" }}>
...
<Update label="February 20th, 2026" tags={["Added"]} rss={{ title: "Attio CRM Integration Now Available" }}>
...
<Update label="February 20th, 2026" tags={["Added"]} rss={{ title: "Dust is now a Single Page Application" }}>
...
<Update label="February 18th, 2026" tags={["Added"]} rss={{ title: "Intercom Official MCP Server Now Available in Dust" }}>
...
<Update label="February 18th, 2026" tags={["Added"]} rss={{ title: "Claude Sonnet 4.6 Now Available in Agent Builder" }}>
...
<Update label="February 11th, 2026" tags={["Added"]} rss={{ title: "🆕 Dust Agents Can Now Create and Edit Google Drive Documents" }}>
...
<Update label="February 5th, 2026" tags={["Added"]} rss={{ title: "🔗✨ Message Reactions & Message Links in Conversations" }}>
...
<Update label="February 5th, 2026" tags={["Added"]} rss={{ title: "Granola Official MCP Server Now Available in Dust" }}>
...
<Update label="February 5th, 2026" tags={["Added"]} rss={{ title: "CSV Export for Programmatic Cost Chart" }}>
...
<Update label="February 5th, 2026" tags={["Added"]} rss={{ title: "🆕 Statuspage MCP Server Integration Now Available" }}>
...
<Update label="February 3rd, 2026" tags={["Added"]} rss={{ title: "📊 Agent Builder Insights: Real-time Observability Dashboard" }}>
...
<Update label="February 3rd, 2026" tags={["Added"]} rss={{ title: "Daily Spending Cap for API Usage" }}>
...
<Update label="January 30th, 2026" tags={["Added"]} rss={{ title: "Export Frames as PDF" }}>
...
<Update label="January 29th, 2026" tags={["Added"]} rss={{ title: "Per API-Key Usage Cap" }}>
...
<Update label="January 29th, 2026" tags={["Added"]} rss={{ title: "📬 Email Notifications Now Include Conversation Summaries" }}>
...
<Update label="January 28th, 2026" tags={["Added"]} rss={{ title: "Discover Existing Skills Before You Build – Automatic Similar Skills Detection" }}>
...
<Update label="January 28th, 2026" tags={["Added"]} rss={{ title: "📧 Gmail Integration: Send Emails Directly from Dust" }}>
...
<Update label="January 28th, 2026" tags={["Added"]} rss={{ title: "✨ More Powerful Image Generation with Gemini 3 Pro" }}>
...
<Update label="January 27th, 2026" tags={["Added"]} rss={{ title: "🆕 Skills: Share Expertise Across All Your Agents" }}>
...
<Update label="January 27th, 2026" tags={["Added"]} rss={{ title: "✨ Customize global skills with your own branding and instructions" }}>
...
<Update label="January 27th, 2026" tags={["Added"]} rss={{ title: "🔍 Discover Tools - Global Skill for Agents" }}>
...
<Update label="January 27th, 2026" tags={["Added"]} rss={{ title: "🔍 Discover Knowledge global skill" }}>
...
<Update label="January 27th, 2026" tags={["Added"]} rss={{ title: "✨ Reference knowledge directly in skill instructions" }}>
...
<Update label="January 27th, 2026" tags={["Added"]} rss={{ title: "⚡ Just-in-time Skills" }}>
  ## ⚡ Just-in-time Skills
...
<Update label="January 26th, 2026" tags={["Added"]} rss={{ title: "✈️ UKG Ready integration for PTO management" }}>
...
<Update label="January 19th, 2026" tags={["Added"]} rss={{ title: "❄️ Snowflake MCP Tool with Personal Authentication" }}>
...
<Update label="January 19th, 2026" tags={["Improved"]} rss={{ title: "⚡ Parallelized Google Drive synchronization" }}>
...
<Update label="January 16th, 2026" tags={["Added"]} rss={{ title: "🔒 Static IP for custom MCP server calls" }}>
...
<Update label="January 16th, 2026" tags={["Added"]} rss={{ title: "🔧 Medium stake tools with per-agent approval history" }}>
...
<Update label="January 13th, 2026" tags={["Added"]} rss={{ title: "⬅️➡️ Navigate between messages in conversation view" }}>
...
<Update label="January 12th, 2026" tags={["Added"]} rss={{ title: "🔌 Productboard integration" }}>
...
<Update label="January 9th, 2026" tags={["Added"]} rss={{ title: "🛡️ Vanta Tools" }}>
  ## 🛡️ Vanta Tools
...
<Update label="January 8th, 2026" tags={["Added"]} rss={{ title: "✏️ Edit and Delete Messages & Conversations" }}>
...
<Update label="January 8th, 2026" tags={["Added"]} rss={{ title: "💬 Mention users in conversations" }}>
...
<Update label="January 8th, 2026" tags={["Added"]} rss={{ title: "🏷️ Mention users in the Agent Builder" }}>
...
<Update label="January 8th, 2026" tags={["Added"]} rss={{ title: "✨ Rich text formatting toolbar in conversations" }}>
...
<Update label="January 8th, 2026" tags={["Added"]} rss={{ title: "🔔 Mention and Agent Notifications" }}>
...
<Update label="January 8th, 2026" tags={["Added"]} rss={{ title: "📬 New Inbox for Mentions and Notifications" }}>
...
<Update label="December 23rd, 2025" tags={["Added"]} rss={{ title: "🧠 Guru Integration Now Available" }}>
...
<Update label="December 23rd, 2025" tags={["Added"]} rss={{ title: "🆕 Freshservice MCP Tool Integration" }}>
...
<Update label="December 18th, 2025" tags={["Added"]} rss={{ title: "☁️ Dust n8n node now available on n8n Cloud" }}>
...
<Update label="December 17th, 2025" tags={["Added"]} rss={{ title: "⚡ Gemini 3 Flash model now available" }}>
...
<Update label="December 16th, 2025" tags={["Added"]} rss={{ title: "💾 Draft Mode: Auto-save your messages" }}>
...
<Update label="December 16th, 2025" tags={["Added"]} rss={{ title: "😊 Emoji shortcode support in messages" }}>
...
<Update label="December 15th, 2025" tags={["Added"]} rss={{ title: "📎 Search and Attach Files from Tools" }}>
...
<Update label="December 11th, 2025" tags={["Added"]} rss={{ title: "🔍✨ Advanced Search & Pagination for GitHub MCP Issues & PRs" }}>
...
<Update label="December 11th, 2025" tags={["Added"]} rss={{ title: "💳 Programmatic Usage Tracking and Billing" }}>
...
<Update label="December 11th, 2025" tags={["Improved"]} rss={{ title: "⚡ Search Latency Improvements" }}>
...
<Update label="November 28th, 2025" tags={["Added"]} rss={{ title: "🤖 Structured Response Format for Claude Sonnet 4.5" }}>
...
<Update label="November 28th, 2025" tags={["Improved"]} rss={{ title: "🔍 Better user search with accent support" }}>
...
<Update label="November 25th, 2025" tags={["Added"]} rss={{ title: "🎛️ Customizable tool approval settings for MCP tools" }}>
...
<Update label="November 25th, 2025" tags={["Added"]} rss={{ title: "🎟️ Linear Built-in Webhook Provider" }}>
...
<Update label="November 18th, 2025" tags={["Improved"]} rss={{ title: "🔐 Granular site access for Microsoft service principals" }}>
...
<Update label="November 17th, 2025" tags={["Improved"]} rss={{ title: "💬 Improved agent tagging in Slack" }}>
...
<Update label="November 14th, 2025" tags={["Added"]} rss={{ title: "🖼️✨ Image Editing Tool" }}>
...
<Update label="November 14th, 2025" tags={["Added"]} rss={{ title: "🤖 GPT-5.1 now available in the builder" }}>
...
<Update label="November 13th, 2025" tags={["Added"]} rss={{ title: "📊 Agent Builder Insights tab" }}>
...
<Update label="November 13th, 2025" tags={["Added"]} rss={{ title: "🎙️ Fathom webhook integration" }}>
...
<Update label="November 13th, 2025" tags={["Added"]} rss={{ title: "🎫 Zendesk built-in webhooks" }}>
...
<Update label="November 13th, 2025" tags={["Added"]} rss={{ title: "🎫 Zendesk tools" }}>
  ## 🎫 Zendesk tools
...
<Update label="November 12th, 2025" tags={["Added"]} rss={{ title: "✉️ Improved invitation flow and workspace selection" }}>
...
<Update label="November 10th, 2025" tags={["Added"]} rss={{ title: "🎫 Jira Built-in Webhook Provider" }}>
...
<Update label="November 10th, 2025" tags={["Added"]} rss={{ title: "🔗 GitHub Built-in Webhook" }}>
...
<Update label="November 10th, 2025" tags={["Added"]} rss={{ title: "🌀 Webhooks as triggers" }}>
...
<Update label="November 7th, 2025" tags={["Added"]} rss={{ title: "🚀 Auto-create Spaces for provisioned groups" }}>
...
<Update label="November 6th, 2025" tags={["Improved"]} rss={{ title: "⚡ Lightning-Fast Photo-Realistic Image Generation" }}>
...
<Update label="November 5th, 2025" tags={["Improved"]} rss={{ title: "🤖 Dust is now your default agent" }}>
...
<Update label="November 5th, 2025" tags={["Added"]} rss={{ title: "🔌 Global Agent Can Now Query Data Warehouses" }}>
...
<Update label="November 5th, 2025" tags={["Added"]} rss={{ title: "🧠 Dust Global Agent Now Uses Memory" }}>
...
<Update label="November 5th, 2025" tags={["Added"]} rss={{ title: "🔍 Advanced Search now available on Dust global agent" }}>
...
<Update label="November 3rd, 2025" tags={["Added"]} rss={{ title: "🎉 Dust Google Sheets Add-on now available on Google Workspace Marketplace" }}>
...
<Update label="October 31st, 2025" tags={["Improved"]} rss={{ title: "🔧 Slack MCP server improvements" }}>
...
<Update label="October 31st, 2025" tags={["Added"]} rss={{ title: "📊 Excel MCP Server integration with SharePoint and OneDrive" }}>
...
<Update label="October 31st, 2025" tags={["Added"]} rss={{ title: "🔗 Microsoft Teams MCP" }}>
  ## 🔗 Microsoft Teams MCP
...
<Update label="October 31st, 2025" tags={["Added"]} rss={{ title: "📁 New SharePoint and OneDrive integration" }}>
...
<Update label="October 31st, 2025" tags={["Added"]} rss={{ title: "🤝 Microsoft Teams Dust Bot" }}>
...
<Update label="October 27th, 2025" tags={["Added"]} rss={{ title: "🧠 Dynamic toolset discovery for Dust assistant" }}>
...
<Update label="October 23rd, 2025" tags={["Added"]} rss={{ title: "🔊 Voice generation tools" }}>
...
<Update label="October 23rd, 2025" tags={["Added"]} rss={{ title: "✨ Data warehouse exploration for Deep Dive" }}>
...
<Update label="October 23rd, 2025" tags={["Improved"]} rss={{ title: "🌐⚡ Offloaded Browsing with AI Summaries" }}>
...
<Update label="October 23rd, 2025" tags={["Added"]} rss={{ title: "🔨 ✨ Dynamic Tool Discovery with Toolsets" }}>
...
<Update label="October 23rd, 2025" tags={["Improved"]} rss={{ title: "🧠 Better Context Management for All Agents" }}>
...
<Update label="October 23rd, 2025" tags={["Added"]} rss={{ title: "🧠 New Go Deep Tool for enhanced agent capabilities" }}>
...
<Update label="October 23rd, 2025" tags={["Added"]} rss={{ title: "🧠 New Deep Dive agent for comprehensive research" }}>
...
<Update label="October 23rd, 2025" tags={["Added"]} rss={{ title: "🤖 Agent handover now supports direct conversation responses" }}>
...
<Update label="October 23rd, 2025" tags={["Added"]} rss={{ title: "🧠 Advanced Search Mode for Agents" }}>
...
<Update label="October 22nd, 2025" tags={["Added"]} rss={{ title: "🚀 Val Town MCP Server Integration" }}>
...
<Update label="October 21st, 2025" tags={["Added"]} rss={{ title: "🔗🦊 GitLab Official MCP Integration" }}>
...
<Update label="October 17th, 2025" tags={["Added"]} rss={{ title: "🛠️ New agent tools: time, wait, and random utilities" }}>
...
<Update label="October 16th, 2025" tags={["Deprecated"]} rss={{ title: "🕐 Dust Apps creation disabled for new workspaces" }}>
...
<Update label="October 15th, 2025" tags={["Added"]} rss={{ title: "🤖 Claude 4.5 Haiku model now available" }}>
...
<Update label="October 15th, 2025" tags={["Added"]} rss={{ title: "🖼️ Frames: Interactive responses for your agents" }}>
...
<Update label="October 13th, 2025" tags={["Improved"]} rss={{ title: "📱 Mobile and tablet experience improvements" }}>
...
<Update label="October 10th, 2025" tags={["Added"]} rss={{ title: "📄 Document sharing in Slack channels" }}>
...
<Update label="October 9th, 2025" tags={["Added"]} rss={{ title: "🎙️ Voice input and audio file support" }}>
...
<Update label="October 8th, 2025" tags={["Added"]} rss={{ title: "📝 (preview) Confluence Tool bring page creation and updates to Dust agents" }}>
...
<Update label="October 7th, 2025" tags={["Added"]} rss={{ title: "📚 Select entire datasources from search" }}>
...
<Update label="September 29th, 2025" tags={["Added"]} rss={{ title: "📎 Auto-attachment for long pasted text" }}>
...
<Update label="September 19th, 2025" tags={["Added"]} rss={{ title: "🔑 GitHub Tool now supports personal credentials" }}>
...
<Update label="September 19th, 2025" tags={["Added"]} rss={{ title: "📁 Google Drive Tool for real-time document access" }}>
...
<Update label="September 18th, 2025" tags={["Added"]} rss={{ title: "🎉 Microsoft Excel Extension" }}>
...
<Update label="September 16th, 2025" tags={["Added"]} rss={{ title: "🎫 Jira integration now globally available" }}>
...
<Update label="September 16th, 2025" tags={["Added"]} rss={{ title: "⏰ Agent Scheduling" }}>
  ## ⏰ Agent Scheduling
...
<Update label="September 15th, 2025" tags={["Added"]} rss={{ title: "👍 Agent feedback reactions in Slack" }}>
...
<Update label="September 8th, 2025" tags={["Added"]} rss={{ title: "🔧 Retry policies for Dust-provided tools" }}>
...
<Update label="September 5th, 2025" tags={["Added"]} rss={{ title: "👀 'Used by' columns for tools in Space admin" }}>
...
<Update label="September 4th, 2025" tags={["Added"]} rss={{ title: "💬 Unread message indicators for conversations" }}>
...
<Update label="September 2nd, 2025" tags={["Improved"]} rss={{ title: "🤖 Complete redesign of agent creation interface" }}>
...
<Update label="September 1st, 2025" tags={["Added"]} rss={{ title: "⚡ Zapier integration now supports non-blocking requests" }}>
...
<Update label="August 30th, 2025" tags={["Added"]} rss={{ title: "🔄 Asana available as tool" }}>
...
<Update label="August 26th, 2025" tags={["Added"]} rss={{ title: "🪐 Cross-space tool and datasource access for Agents" }}>
...
<Update label="August 25th, 2025" tags={["Added"]} rss={{ title: "⚡️ Long-Running Durable Agents" }}>
...
<Update label="August 22nd, 2025" tags={["Added"]} rss={{ title: "🔍 Channel selection for Slack tool" }}>
...
<Update label="August 14th, 2025" tags={["Improved"]} rss={{ title: "🔧 Multiple workspace selection in Agent Builder" }}>
...
<Update label="August 13th, 2025" tags={["Added"]} rss={{ title: "✈️ Seamless cross-region workspace switching" }}>
...
<Update label="August 12th, 2025" tags={["Improved"]} rss={{ title: "🌐 Enhanced Web Search & Browse with HTML and Screenshot Support" }}>
...
<Update label="August 11th, 2025" tags={["Added"]} rss={{ title: "🛠️ Tools Now Available in Conversations" }}>
...
<Update label="August 11th, 2025" tags={["Added"]} rss={{ title: "🤖 Added GPT-5 model support" }}>
...
<Update label="August 7th, 2025" tags={["Added"]} rss={{ title: "🔗 Personal Notion integration support" }}>
...
<Update label="August 7th, 2025" tags={["Added"]} rss={{ title: "📂 Added support for Confluence folder content synchronization" }}>
...
<Update label="August 1st, 2025" tags={["Added"]} rss={{ title: "🎛️ Filter Zendesk ticket syncing with tags" }}>
...
<Update label="August 1st, 2025" tags={["Added"]} rss={{ title: "🔄 Support for duplicate MCP server URLs" }}>
...
<Update label="August 1st, 2025" tags={["Added"]} rss={{ title: "🎛️ Selective MCP Tool Enablement" }}>
...
<Update label="July 30th, 2025" tags={["Added"]} rss={{ title: "🗓️ New Outlook Calendar integration" }}>
...
<Update label="July 30th, 2025" tags={["Added"]} rss={{ title: "📧 Connect and manage Outlook emails in Dust" }}>
...
<Update label="July 29th, 2025" tags={["Added"]} rss={{ title: "🗄️ Improved table storage infrastructure" }}>
...
<Update label="July 29th, 2025" tags={["Added"]} rss={{ title: "🔐 Personal authentication mode for HubSpot integration" }}>
...
<Update label="July 25th, 2025" tags={["Added"]} rss={{ title: "🧠 Agent Memory - Store and recall information across conversations" }}>
...
<Update label="July 21st, 2025" tags={["Removed"]} rss={{ title: "🔒 Standardized agent step limit to 128" }}>
...
<Update label="July 18th, 2025" tags={["Improved"]} rss={{ title: "🎨 Enhanced error message visualization" }}>
...
<Update label="July 17th, 2025" tags={["Added"]} rss={{ title: "🤖 New Kimi K2 Instruct model available" }}>
...
<Update label="July 11th, 2025" tags={["Added"]} rss={{ title: "📧 Gmail Tool now reads and replies to email threads" }}>
...
<Update label="July 10th, 2025" tags={["Added"]} rss={{ title: "📄 Self-serve PDF scanning controls and workspace storage limits" }}>
...
<Update label="July 9th, 2025" tags={["Added"]} rss={{ title: "💳 SEPA Direct Debit Support" }}>
...
<Update label="July 8th, 2025" tags={["Added"]} rss={{ title: "📊 Google Sheets integration with read and write capabilities" }}>
...
<Update label="July 7th, 2025" tags={["Improved"]} rss={{ title: "🔄 Enhanced HubSpot integration capabilities" }}>
...
<Update label="July 7th, 2025" tags={["Added"]} rss={{ title: "🔧 Linear Integration Available as a Tool" }}>
...
<Update label="July 7th, 2025" tags={["Added"]} rss={{ title: "🧠 New Reasoning Effort Controls for Language Models" }}>
...
<Update label="July 3rd, 2025" tags={["Added"]} rss={{ title: "✈️ Import Front Conversations Feature" }}>
...
<Update label="July 3rd, 2025" tags={["Improved"]} rss={{ title: "🧠 Enhanced OpenAI Model Reasoning" }}>
...
<Update label="July 3rd, 2025" tags={["Added"]} rss={{ title: "💳 Stripe integration now available as a tool" }}>
...
<Update label="July 2nd, 2025" tags={["Added"]} rss={{ title: "🔍 New Slack Tool: Search and Post Messages" }}>
...
<Update label="July 2nd, 2025" tags={["Added"]} rss={{ title: "🔄 SCIM User and Group Provisioning Support" }}>
...
<Update label="June 30th, 2025" tags={["Added"]} rss={{ title: "🤖 Non-Interactive Chat Support in CLI" }}>
...
<Update label="June 27th, 2025" tags={["Added"]} rss={{ title: "🔌 New Salesforce Integration" }}>
...
<Update label="June 25th, 2025" tags={["Improved"]} rss={{ title: "🔌 Gmail & Google Calendar tools now available with simple authentication" }}>
...
<Update label="June 24th, 2025" tags={["Improved"]} rss={{ title: "🔄 Authentication System Upgrade" }}>
...
<Update label="June 24th, 2025" tags={["Added"]} rss={{ title: "🛠️ Enhanced CLI with new flags, commands and caching" }}>
...
<Update label="June 24th, 2025" tags={["Added"]} rss={{ title: "🔍 Improved BigQuery views support" }}>
...
<Update label="June 24th, 2025" tags={["Added"]} rss={{ title: "🕷️ Enhanced Web Crawler with Advanced Features" }}>
...
<Update label="June 20th, 2025" tags={["Added"]} rss={{ title: "🔍 Notion Page Visibility Checker" }}>
...
<Update label="June 19th, 2025" tags={["Added"]} rss={{ title: "🔑 Support for Snowflake key pair authentication" }}>
...
<Update label="June 18th, 2025" tags={["Added"]} rss={{ title: "🔍 Search for documents by URL" }}>
...
<Update label="June 16th, 2025" tags={["Added"]} rss={{ title: "🔄 New script for importing Planhat data" }}>
...
<Update label="June 16th, 2025" tags={["Improved"]} rss={{ title: "🔄 Enhanced Zendesk App with Extended Response Time" }}>
...
<Update label="June 11th, 2025" tags={["Added"]} rss={{ title: "🤖 New Run Agent Tool" }}>
  ## 🤖 New Run Agent Tool
...
<Update label="June 11th, 2025" tags={["Added"]} rss={{ title: "🔐 Added OAuth credential options for remote MCP servers" }}>
...
<Update label="June 11th, 2025" tags={["Added"]} rss={{ title: "🔐 Flexible authentication options for Salesforce integration" }}>
...
<Update label="June 10th, 2025" tags={["Added"]} rss={{ title: "🔄 Salesforce SOQL Query Sync Support" }}>
...
<Update label="June 6th, 2025" tags={["Added"]} rss={{ title: "🔐 OAuth Authentication Support for Remote MCP Servers" }}>
...
<Update label="June 4th, 2025" tags={["Added"]} rss={{ title: "📝 New Notion Agent Tool" }}>
...
<Update label="June 4th, 2025" tags={["Added"]} rss={{ title: "📂 Dropbox Files Import Integration" }}>
...
<Update label="June 4th, 2025" tags={["Added"]} rss={{ title: "🔌 New Hubspot Integration Tool" }}>
...
<Update label="June 2nd, 2025" tags={["Added"]} rss={{ title: "🤖 New xAI Grok Models Available" }}>
...
<Update label="May 30th, 2025" tags={["Improved"]} rss={{ title: "📊 Enhanced Google Sheets data selection capabilities" }}>
...
<Update label="May 27th, 2025" tags={["Added"]} rss={{ title: "🔐 Personal Tools Support" }}>
...
<Update label="May 26th, 2025" tags={["Improved"]} rss={{ title: "🚀 System-wide performance optimizations" }}>
...
<Update label="May 24th, 2025" tags={["Improved"]} rss={{ title: "🔌 Remote MCP Server Connection Enhancements" }}>
...
<Update label="May 15th, 2025" tags={["Added"]} rss={{ title: "🏷️ Improved Assistant Discovery and Organization" }}>
...
<Update label="May 15th, 2025" tags={["Added"]} rss={{ title: "🛠️ New GitHub Tools" }}>
  ## 🛠️ New GitHub Tools
...
<Update label="May 15th, 2025" tags={["Improved"]} rss={{ title: "🔄 Simplified Assistant Builder Interface" }}>
...
<Update label="May 14th, 2025" tags={["Added"]} rss={{ title: "🎉 MCP Support Now Available for All Workspaces" }}>
...
<Update label="May 12th, 2025" tags={["Added"]} rss={{ title: "🖥️ Chat with Dust Agents via CLI" }}>
...
<Update label="May 2nd, 2025" tags={["Added"]} rss={{ title: "📊 BigQuery table descriptions available to Agents" }}>
...
<Update label="April 30th, 2025" tags={["Added"]} rss={{ title: "🤖 Smarter Agent Recommendations" }}>
...
<Update label="April 24th, 2025" tags={["Added"]} rss={{ title: "🎨 GPT Image Model Integration for Enhanced Image Generation" }}>
...
<Update label="April 23rd, 2025" tags={["Improved"]} rss={{ title: "🔄 Enhanced Extract Data Tool Capabilities" }}>
...
<Update label="April 17th, 2025" tags={["Added"]} rss={{ title: "🛠️ Preview: New Tools and External MCP Server Support in Agents" }}>
...
<Update label="April 17th, 2025" tags={["Added"]} rss={{ title: "🤖 New OpenAI o4-mini Model Available" }}>
...
<Update label="April 16th, 2025" tags={["Added"]} rss={{ title: "🤖 GPT-4.1 Model Now Available" }}>
...
<Update label="April 15th, 2025" tags={["Added"]} rss={{ title: "🔧 Structured JSON Output Support for OpenAI Models" }}>
...
<Update label="April 11th, 2025" tags={["Added"]} rss={{ title: "🔌 Personal connections support for Salesforce connector" }}>
...
<Update label="April 8th, 2025" tags={["Added"]} rss={{ title: "🧪 Import Linear Issues Feature" }}>
  ## 🧪 Import Linear Issues Feature

  • New script to import issues from Linear into Dust<br />• Available in dust-labs repository
</Update>

<Update label="April 8th, 2025" tags={["Improved"]} rss={{ title: "🔗 Smoother account linking experience" }}>
...
<Update label="April 8th, 2025" tags={["Added"]} rss={{ title: "🤖 Gemini 2.5 Pro available in Custom Agents" }}>
...
<Update label="April 4th, 2025" tags={["Added"]} rss={{ title: "🌗 Chrome extension now supports Dark mode" }}>
...
<Update label="April 3rd, 2025" tags={["Added"]} rss={{ title: "🖥️ New Dust CLI Tool" }}>
  ## 🖥️ New Dust CLI Tool
...
<Update label="April 2nd, 2025" tags={["Added"]} rss={{ title: "📎 Attach Knowledge Items Directly in Input Bar" }}>
...
<Update label="April 2nd, 2025" tags={["Added"]} rss={{ title: "🔑 Service Principal authentication for Microsoft connector" }}>
...
<Update label="March 7th, 2025" tags={["Improved"]} rss={{ title: "🔍 Smarter label filtering with dynamic search" }}>
...
<Update label="March 6th, 2025" tags={["Added"]} rss={{ title: "🔌 Native Gong Integration Released" }}>
...
<Update label="March 4th, 2025" tags={["Added"]} rss={{ title: "🔍 Added keyword search in Builder and Knowledge" }}>
...
<Update label="February 28th, 2025" tags={["Improved"]} rss={{ title: "🎯 Solutions Pages Revamp with Enhanced Use Cases" }}>
...
<Update label="February 28th, 2025" tags={["Improved"]} rss={{ title: "✨ Enhanced markdown support in chat" }}>
...
<Update label="February 26th, 2025" tags={["Added"]} rss={{ title: "🌙 Dark mode support" }}>
  ## 🌙 Dark mode support
...
<Update label="February 24th, 2025" tags={["Added"]} rss={{ title: "🤖 Claude 3.7 Sonnet Model Now Available" }}>
...
<Update label="February 24th, 2025" tags={["Added"]} rss={{ title: "🔄 Optional sync of unresolved Zendesk tickets" }}>
...
<Update label="February 19th, 2025" tags={["Added"]} rss={{ title: "🏷️ Enhanced data filtering with labels" }}>
...
<Update label="February 14th, 2025" tags={["Added"]} rss={{ title: "Notion management: Admins can force sync pages/dbs" }}>
...
<Update label="February 14th, 2025" tags={["Added"]} rss={{ title: "🔌 BigQuery Connector Now Available" }}>
...
<Update label="February 14th, 2025" tags={["Improved"]} rss={{ title: "🧩 Browser Extension Updates" }}>
...
<Update label="February 13th, 2025" tags={["Added"]} rss={{ title: "📊 Support for Excel file uploads in conversations" }}>
...
<Update label="February 11th, 2025" tags={["Added"]} rss={{ title: "🏢 New About Us page" }}>
  ## 🏢 New About Us page
...
<Update label="February 11th, 2025" tags={["Added"]} rss={{ title: "🔌 Released Dust Node for n8n Integration" }}>
...
<Update label="February 7th, 2025" tags={["Added"]} rss={{ title: "🇪🇺 EU Data Hosting Option Available" }}>
...
<Update label="February 6th, 2025" tags={["Added"]} rss={{ title: "🔌 BigQuery Connector Beta Release" }}>
...
<Update label="February 3rd, 2025" tags={["Added"]} rss={{ title: "🤖 OpenAI O3-mini model now available" }}>
...
<Update label="January 29th, 2025" tags={["Added"]} rss={{ title: "🐳 New DeepSeek R1 Global Agent" }}>
...
<Update label="January 29th, 2025" tags={["Added"]} rss={{ title: "🧠 New Reasoning Tool for Assistants" }}>
...
<Update label="January 29th, 2025" tags={["Added"]} rss={{ title: "🏥 HIPAA Compliance Certification" }}>
  ## 🏥 HIPAA Compliance Certification

  • Dust is now HIPAA compliant<br />• Documentation can be found on the security page and on Dusts' trust center
</Update>

<Update label="January 28th, 2025" tags={["Added"]} rss={{ title: "👥 Batch member addition in Space settings" }}>
...
<Update label="January 25th, 2025" tags={["Added"]} rss={{ title: "🔗 Slack bot now includes thread files in conversations" }}>
...
<Update label="January 24th, 2025" tags={["Added"]} rss={{ title: "🎙️ Added Modjo as a transcripts processing provider" }}>
...
<Update label="January 24th, 2025" tags={["Added"]} rss={{ title: "🔍 OCR Support for uploaded PDF Files" }}>
...
<Update label="January 24th, 2025" tags={["Improved"]} rss={{ title: "🧩 Browser Extension Updates" }}>
  ## 🧩 Browser Extension Updates
...
<Update label="January 23rd, 2025" tags={["Improved"]} rss={{ title: "🔒 Completed Annual Security Certification" }}>
...
<Update label="January 21st, 2025" tags={["Added"]} rss={{ title: "📦 Extended File Format Support for Attachments" }}>
...
<Update label="January 17th, 2025" tags={["Improved"]} rss={{ title: "📂 More granular file selection in assistant tools" }}>
...
<Update label="January 17th, 2025" tags={["Improved"]} rss={{ title: "🔄 Increased default and maximum steps for assistant runs" }}>
...
<Update label="January 16th, 2025" tags={["Improved"]} rss={{ title: "📱 Improved conversation layout responsiveness" }}>
...
<Update label="January 14th, 2025" tags={["Improved"]} rss={{ title: "🔒 Reduced Google Meet permissions scope" }}>
...
<Update label="January 9th, 2025" tags={["Added"]} rss={{ title: "👍 Assistant feedback system launch" }}>
...
<Update label="January 8th, 2025" tags={["Added"]} rss={{ title: "⏱️ Conversations now sorted by last activity" }}>
...
<Update label="January 6th, 2025" tags={["Added"]} rss={{ title: "🤖 DeepSeek V3 Model Now Available" }}>
...
<Update label="December 30th, 2024" tags={["Added"]} rss={{ title: "🚫 New option to skip storage of Dust app execution logs" }}>
...
<Update label="December 19th, 2024" tags={["Added"]} rss={{ title: "⚡️ Faster conversation page loading" }}>
...
<Update label="December 19th, 2024" tags={["Added"]} rss={{ title: "📚 New Dust Enterprise Rollout Guide" }}>
...
<Update label="December 18th, 2024" tags={["Added"]} rss={{ title: "🎙️ Added support for Modjo transcripts processing" }}>
...
<Update label="December 16th, 2024" tags={["Added"]} rss={{ title: "🎯 Zendesk integration now available publicly" }}>
...
<Update label="December 5th, 2024" tags={["Added"]} rss={{ title: "💾 Prompt version history" }}>
  ## 💾 Prompt version history

  • Added ability to recover previous assistant instructions<br />• Each version of a prompt is now saved and accessible
</Update>

<Update label="December 3rd, 2024" tags={["Added"]} rss={{ title: "🧩 Chrome Extension Now Available on Chrome Web Store" }}>
...
<Update label="December 3rd, 2024" tags={["Added"]} rss={{ title: "🔐 SAML SSO Authentication Support" }}>
...
<Update label="November 28th, 2024" tags={["Added"]} rss={{ title: "🎫 New Zendesk connection" }}>
...
<Update label="November 27th, 2024" tags={["Improved"]} rss={{ title: "📄 Enhanced document upload capabilities" }}>
...
<Update label="November 27th, 2024" tags={["Added"]} rss={{ title: "👍 New feedback system with thumbs up/down reactions" }}>
...
<Update label="November 27th, 2024" tags={["Added"]} rss={{ title: "🔄 New PagerDuty Schedule Import Script" }}>
...
<Update label="November 20th, 2024" tags={["Added"]} rss={{ title: "🔍 Code inspection for visualizations" }}>
...
<Update label="November 15th, 2024" tags={["Improved"]} rss={{ title: "🚀 Enhanced Raycast Extension with New Features" }}>
...
<Update label="November 13th, 2024" tags={["Added"]} rss={{ title: "🎨 Visualization and web search features enabled in assistants" }}>
...
<Update label="November 13th, 2024" tags={["Improved"]} rss={{ title: "🔄 Enhanced Zendesk Integration" }}>
...
<Update label="November 13th, 2024" tags={["Added"]} rss={{ title: "📊 Added CSV support and export in Visualization" }}>
...
<Update label="November 12th, 2024" tags={["Added"]} rss={{ title: "🔒 Private Slack channels indexing (available on request)" }}>
...
<Update label="November 12th, 2024" tags={["Improved"]} rss={{ title: "🔄 'Most Recent Data' Tool Renamed to 'Include Data'" }}>
...
<Update label="November 10th, 2024" tags={["Improved"]} rss={{ title: "🎨 Enhanced UI Design System" }}>
...
<Update label="November 7th, 2024" tags={["Improved"]} rss={{ title: "🔍 Enhanced Extract Tool with Improved Context Awareness" }}>
...
<Update label="November 5th, 2024" tags={["Improved"]} rss={{ title: "🤖 Claude 3.5 Haiku Integration" }}>
...
<Update label="October 29th, 2024" tags={["Added"]} rss={{ title: "💾 Store Google Meet and Gong Meeting Transcripts" }}>
...
<Update label="October 28th, 2024" tags={["Improved"]} rss={{ title: "🔄 New Google Sheets Integration with Sidebar" }}>
...
<Update label="October 25th, 2024" tags={["Improved"]} rss={{ title: "🤖 Updated Claude 3.5 Sonnet model version" }}>
...
<Update label="October 23rd, 2024" tags={["Added"]} rss={{ title: "🚀 Spaces: Enhanced Data Management" }}>
...
<Update label="October 21st, 2024" tags={["Added"]} rss={{ title: "🌨️ Snowflake Integration: Connect and Query Your Data" }}>
...
<Update label="October 18th, 2024" tags={["Added"]} rss={{ title: "🚨 Dust Incidents Now Visible in UI" }}>
...
<Update label="October 17th, 2024" tags={["Added"]} rss={{ title: "⭐️ Add Assistant to Favorites" }}>
...
<Update label="October 10th, 2024" tags={["Improved"]} rss={{ title: "📊 Tables Query outputs now available as file attachments" }}>
...
<Update label="October 10th, 2024" tags={["Improved"]} rss={{ title: "🚀 Slack Integration Enhancements" }}>
...
<Update label="October 10th, 2024" tags={["Improved"]} rss={{ title: "📚 Updated Documentation and Video Guides for Data Management" }}>
...
<Update label="October 8th, 2024" tags={["Added"]} rss={{ title: "📘 OpenAPI definition and Postman collection now available" }}>
...
<Update label="October 4th, 2024" tags={["Improved"]} rss={{ title: "📁 Enhanced Folder Naming Flexibility" }}>
...
<Update label="September 26th, 2024" tags={["Added"]} rss={{ title: "📸 Download Visualizations" }}>
...
<Update label="September 24th, 2024" tags={["Improved"]} rss={{ title: "🔍 Improved Data Source Exploration" }}>
...
<Update label="September 18th, 2024" tags={["Added"]} rss={{ title: "🗑️ Multi-select and bulk delete conversations" }}>
...
<Update label="September 12th, 2024" tags={["Added"]} rss={{ title: "🧪 Zendesk Knowledge Base Import Tool" }}>
...
<Update label="September 10th, 2024" tags={["Removed"]} rss={{ title: "🔒 Removal of public Dust apps" }}>
...
<Update label="September 6th, 2024" tags={["Added"]} rss={{ title: "🔗 Make.com Integration Added" }}>
...
<Update label="September 4th, 2024" tags={["Added"]} rss={{ title: "🧪 [Dust Labs] Hubspot Companies to Dust Datasource Exporter" }}>
...
<Update label="September 4th, 2024" tags={["Improved"]} rss={{ title: "🔍 Improved search accuracy for specific data sources" }}>
...
<Update label="August 30th, 2024" tags={["Added"]} rss={{ title: "🎙️ New Gong Transcripts Exporter for Dust" }}>
...
<Update label="August 29th, 2024" tags={["Added"]} rss={{ title: "🔗 New Microsoft SharePoint Connector" }}>
...
<Update label="August 27th, 2024" tags={["Added"]} rss={{ title: "🤖 New Zapier action to interact with Dust assistants" }}>
...
<Update label="August 27th, 2024" tags={["Added"]} rss={{ title: "🚀 Dust for Google Spreadsheets (Beta)" }}>
...
<Update label="August 21st, 2024" rss={{ title: "🧪 [Dust Labs] Jira Issues To Dust Import Script" }}>
...
<Update label="August 19th, 2024" rss={{ title: "🧪 [Dust Labs] Salesforce Accounts To Dust Import Script" }}>
...
<Update label="August 13th, 2024" tags={["Added"]} rss={{ title: "🚀 Provider Status Page Updates" }}>
...
<Update label="August 2nd, 2024" tags={["Added"]} rss={{ title: "🎨 Data Visualization with React Components" }}>
...
<Update label="July 26th, 2024" tags={["Added"]} rss={{ title: "🔐 Microsoft Entra ID SSO now available" }}>
...
<Update label="July 26th, 2024" tags={["Added"]} rss={{ title: "🔌 Microsoft SharePoint Connector (Beta)" }}>
...
<Update label="July 23rd, 2024" tags={["Added"]} rss={{ title: "🚀 GPT4o mini model now available in assistant builder" }}>
...
<Update label="July 22nd, 2024" tags={["Removed"]} rss={{ title: "🔥 Nango dependency removed from connectors" }}>
...
<Update label="July 18th, 2024" tags={["Added"]} rss={{ title: "🖼️ Vision Capabilities Added to Anthropic Models" }}>
...
<Update label="July 8th, 2024" tags={["Improved"]} rss={{ title: "🚀 Drag-and-Drop File Support in Conversations" }}>
...
<Update label="July 4th, 2024" tags={["Added"]} rss={{ title: "🖼️ Vision Support Added to the App" }}>
...
<Update label="July 3rd, 2024" tags={["Improved"]} rss={{ title: "📊 Workspace Metrics: Monthly Reports Now Available" }}>
...
<Update label="July 2nd, 2024" tags={["Improved"]} rss={{ title: "🎨 Emoji Suggestions for New Assistants" }}>
...
<Update label="July 1st, 2024" tags={["Fixed"]} rss={{ title: "🔢 LaTeX Equations Now Supported in Agent Messages" }}>
...
<Update label="July 1st, 2024" tags={["Deprecated"]} rss={{ title: "Removal of @github, @notion and @slack global assistants" }}>
...
<Update label="June 26th, 2024" tags={["Added"]} rss={{ title: "Product Update 4" }}>
  ## Product Update 4
...
<Update label="June 24th, 2024" tags={["Improved"]} rss={{ title: "New documentation & developer platform" }}>
...
<Update label="May 21st, 2024" tags={["Added"]} rss={{ title: "Product update 3" }}>
  ## Product update 3
...
<Update label="April 18th, 2024" tags={["Added"]} rss={{ title: "Product update 2" }}>
  ## Product update 2
...
<Update label="March 21st, 2024" tags={["Added"]} rss={{ title: "Product update 1" }}>
  ## Product update 1

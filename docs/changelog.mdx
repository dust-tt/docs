...
Dust now supports xAI's Grok 4.6, its latest flagship model for coding and long-running agentic work. It supports reasoning, vision and structured output.

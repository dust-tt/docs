...
You can now choose which model runs your agent directly from the composer. Pick a specific model or use Dust-managed Fast, Standard, or Complex modes to balance response quality, speed, and cost for each task. You can also switch models manually when a provider is unavailable.

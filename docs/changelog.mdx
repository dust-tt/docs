...
<Update label="August 12th, 2026" tags={["Added"]}>
## Grok 4.6 is now available on Dust

Dust now supports xAI's Grok 4.6, its latest flagship model for coding and long-running agentic work. It supports reasoning, vision, structured output, and up to 256k context in Dust.

The global Analyst agent and automatic routing when xAI is selected now prefer Grok 4.6. It is available to workspaces with xAI enabled and is currently limited to US regions.
...
➡️ Connect Data to Dust: [/docs/user-documentation/data-sources/connections](/docs/user-documentation/data-sources/connections)\
➡️ Manage Data on Dust (Company Data vs Vaults): [/docs/user-documentation/admins/spaces-management](/docs/user-documentation/admins/spaces-management)\
➡️ Adding data to a vault as an admin: [/docs/user-documentation/admins/spaces-management#how-to-add-data-to-a-vault](/docs/user-documentation/admins/spaces-management#how-to-add-data-to-a-vault)
...
• Documentation available here: [Make.com: Trigger Dust assistants from any scenario](/docs/user-documentation/agents/integrations/make-com)

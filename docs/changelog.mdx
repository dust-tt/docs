...
Grok 4.7 comes with zero data retention standard terms. It is available to everyone automatically, except workspaces configured for EU data residency only.

...
![Granularity selector showing Daily, Weekly, and Monthly options.](https://github.com/user-attachments/assets/d0c20029-9cb4-47d7-9504-d97958c070e7)

![Per-period consumption chart showing the period and granularity controls, stacked consumption, the legend, and the Today partial marker.](https://github.com/user-attachments/assets/cb6eb0cc-9add-4b47-98e4-cf7881d82aed)
